...
import 'package:wellibe_proj/screens/hospitals_view/patients_grid.dart';
...
import 'package:wellibe_proj/screens/authenticate/DoctorRegister.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            TextButton(
              child: const Text('התנתק', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black)),
              onPressed: () async {
                await _auth.signOut();
                print("sign out");
              },
